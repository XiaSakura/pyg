...
app.service('goodsService',function($http){
	...
	this.findGoodsById=function(id){
		return $http.get('../goods/findGoodsById.do?id='+id);
	} 
	
	this.updateGoodsMarketable=function(ids,status){
		return $http.get('../goods/updateGoodsMarketable.do?ids='+ids+"&status="+status);
	}
